            ...
            <div className="home-wrapper" onClick={() => this.handleHamburgerMenu()}>
                ...
                <div className="home-container-wrapper">
                    <div className="home-container">
                        <input className="home-name-input home-inputs" type="text" placeholder="Trip Name" />
                        <div className="home-inputs-container">
                            <input className="home-destination-input home-inputs" type="text" placeholder="Trip Destination" />
                            <input className="home-budget-input home-inputs" type="text" placeholder="Budget for Day" />
                            <textarea className="home-notes-input  home-inputs" type="text" placeholder="import notes, blah, blah, blah.." />
