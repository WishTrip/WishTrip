      ...
      <div className="home-wrapper" onClick={() => this.handleHamburgerMenu()}>
        ...
        <div className="home-container-wrapper">
          <div className="home-container">
            <input
              data-cypress-tripname-input
              className="home-name-input home-inputs"
              type="text"
              placeholder="Trip Name"
              value={tripNameInput}
              onChange={e => this.handleInput("tripNameInput", e.target.value)}
            />
            <div className="home-inputs-container">
              <input
                data-cypress-destination-input
              ...
              />
              <input
                data-cypress-budget-input
                className="home-budget-input home-inputs"
                type="text"
                placeholder="Budget for Day"
                value={budgetInput}
                onChange={e => this.handleInput("budgetInput", e.target.value)}
              />
              <textarea
                data-cypress-notes-input
                className="home-notes-input  home-inputs"
                type="text"
                placeholder="import notes, blah, blah, blah.."
                value={notesInput}
                onChange={e => this.handleInput("notesInput", e.target.value)}
              />
